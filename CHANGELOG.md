...
- Reserved project names validation
...
- Updated all schema maxLength constraints
...
- EIP-55 checksum validation logic
- GitHub workflow permissions for PR commenting
- Schema validation gaps (URL protocols, string lengths)
